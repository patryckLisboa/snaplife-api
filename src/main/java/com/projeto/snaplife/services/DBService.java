...
public class DBService {
	...
	public void instanciaBaseDeDados() throws ParseException {
		...
		Consulta consult1 = new Consulta(c.getTime(), "Pessoa com tendencia a obseidade...", 
				...
				new BigDecimal("1.2"),
				new BigDecimal("2050.00"), "Individo necessita perder peso",new BigDecimal("4001.00"), cli1,"Anotações da prescricap...",
				"perder massa gorda", new BigDecimal("100.00"),  new BigDecimal("100.00"),  new BigDecimal("100.00"),
		...
		refeicaoService.create(consult1.getCodigo(), refeicao1);
		refeicaoService.create(consult1.getCodigo(), refeicao2);
